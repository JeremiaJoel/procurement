...
<body class="bg-gray-100 text-gray-800">
    ...
    <div class="flex h-screen">
        ...
        <aside class="w-64 bg-white text-white flex-shrink-0">
            <nav
                class="bg-white shadow-xl h-screen fixed top-0 left-0 min-w-[250px] py-6 px-4 font-[sans-serif] overflow-auto">
                <div class="relative flex flex-col h-full">
                    ...
                    <div class="flex flex-wrap items-center cursor-pointer relative">
                        ...
                        <div class="ml-4">
                            <p class="text-sm text-[#333] font-semibold">Nama Perusahaan</p>
                            <p class="text-xs text-gray-400 mt-0.5">Company</p>
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 absolute right-0 fill-gray-400"
                    ...
                    <div class="flex-1">
                        <h4 class="text-sm text-gray-400 mb-4">Shared</h4>
                        <ul class="space-y-4 px-2 flex-1">
                            <li>
                                <a href="javascript:void(0)"
                                    class="text-[#333] text-sm flex items-center hover:text-blue-600 transition-all">
                            ...
                            <li>
                                <a href="javascript:void(0)"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" stroke='currentColor'
                                        class="w-4 h-4 mr-4" viewBox="0 0 682.667 682.667">
                                        <defs>
                    ...
                    <div class="mt-4">
                        <ul class="space-y-4 px-2">
                            <li>
                                <a href="javascript:void(0)"
                                    class="text-[#333] text-sm flex items-center hover:text-blue-600 transition-all">
                                    <svg xmlns="http://www.w3.org/2000/svg" l="currentColor" class="w-4 h-4 mr-4"
                                        viewBox="0 0 24 24">
                                        <path
                        ...
                        <div class="flex flex-wrap items-center cursor-pointer border-t py-2 mt-6">
                            ...
                            <div class="ml-4">
                                <p class="text-sm text-[#333] font-semibold">Log Out</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <main class="flex-1 p-6 space-y-6">
            ...
            <div class="flex justify-between items-center">
                <h2 class="text-2xl font-semibold">Welcome, Supplier</h2>
            </div>

            <!-- Cards Row -->
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div class="p-4 bg-white rounded shadow">
                    <h3 class="text-lg font-medium">201</h3>
                    <p class="text-gray-500">Pending PR's</p>
                </div>
                <div class="p-4 bg-white rounded shadow">
                    <h3 class="text-lg font-medium">212</h3>
                    <p class="text-gray-500">Ongoing PR's</p>
                </div>
                <div class="p-4 bg-white rounded shadow">
                    <h3 class="text-lg font-medium">328</h3>
                    <p class="text-gray-500">Moved To Purchase</p>
                </div>
                <div class="p-4 bg-white rounded shadow">
                    <h3 class="text-lg font-medium">170</h3>
                    <p class="text-gray-500">Completed PR's</p>
                </div>
            </div>
